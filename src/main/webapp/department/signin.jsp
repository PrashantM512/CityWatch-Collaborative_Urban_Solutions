            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
				...
				<img alt="Small Image" style="width: 50px; height: 50px;" class="img img-fluid" src="../img/cityscape.png"></i>&nbsp;<img alt="" src="../img/CityWatch.png" style="width: 142px;height: 50px;margin-left: -13px;" class="title">
			        ...
			        <h3>Sign In</h3>
                        ...
                        <button type="submit" class="btn py-3 w-100 mb-4" style="background-color:#0026e1;color:white;">Sign In</button>
                        <p class="text-center mb-0">Normal user or Admin? <a href="../login.jsp">&nbsp; Click Here</a></p>
                    </div>
                </div>
            </div>
        </div>
